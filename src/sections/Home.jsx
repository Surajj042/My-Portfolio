...
const socials = [
  {Icon : FaFacebook , label : "Facebook", href: "https://www.facebook.com/suraj.gurung.sg98"},
  {Icon : FaInstagram , label : "Instagram", href: "https://www.instagram.com/surajjgurung/"},
  {Icon : FaLinkedin , label : "Linkedin", href: "https://www.linkedin.com/in/suraj-gurung-574688207/"},
...
const glowVariants ={
  ...
  hover: {
    scale:1.2, y:-3,
    filter: "drop-shadow(0 0 8px rgba(13,18,204,0.9)) drop-shadow(0 0 18px rgba(16,185,129,0.8)) ",
      ...
      <div className="relative z-10 h-full w-full max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2">
        <div className="flex flex-col justify-center h-full text-center lg:text-left relative">
          <div className="w-full lg:pr-24 mx-auto max-w-[48rem]">
            ...
            >
            <a href="#projects" className="px-6 py-3 rounded-full font-medium text-lg text-white bg-gradient-to-r from-[#6dd5fa] via-[#2a5298] to-[#302b53] shadow-lg hover:scale-105 transition-all
            ">View My Work</a>
        ...
        >
          ...
          <motion.img src={avator} alt="Suraj Gurung" 
