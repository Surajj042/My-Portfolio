...
import { SiLaravel, SiMongodb, SiNextdotjs, SiPhp, SiPython, SiTailwindcss, SiTypescript } from "react-icons/si"
...
useEffect(()=> {
  ...
  return(
    ...
    <motion.h2 className="text-4xl mt-5 sm:text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-[#38b3f4] via-[#397df2] to-[#302b63] z-10 "
    ...
    <motion.div ref={trackRef} className="flex gap-10 text-6xl text-[#52a4df] "
