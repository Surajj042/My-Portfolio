...
export default function About(){
  ...
  return(
    ...
    viewport={{once:true, amount:0.4}}
     ...
     <motion.div className="relative w-[160px] h-[160px] md:w-[200px] md:h-[200px] rounded-2xl overflow-hidden shadow-2xl bg-gradient-to-br from-[#6dd5fa]/20 to-[#302b63]/20 border border-[#6dd5fa]/25 "
    ...
    >
      ...
      <p className="text-gray-300 leading-relaxed text-base sm:text-lg">
        I'm a FullStack Developer - passionate about crafting fast, scalable applications and exploring new technologies.
      </p>
      <p className="mt-4 text-gray-400 text-base sm:text-lg">
        I enjoy turning creative ideas into intuitive, user-friendly products that leave a mark.
      </p>
    </motion.div>
